    ...
    <section>
        <form action="" method="post" enctype="multipart/form-data">
            <table class="table table-hover ">
                ...
                <tr>
                    <td>No Hp</td>
                    <td><input id="telfon" name="telfon" type="Number" class="form-control" value="<?= $siswa["telfon"]?>" aria-label="Username" aria-describedby="basic-addon1"></div></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td><textarea class="form-control" name="alamat" id="alamat" cols="30" rows="3" value="<?= $siswa["alamat"]?>"></textarea></td>
                </tr>
            </table>
            <div class="tombol" >
